        ...
        <div class="lightbox-gallery uk-grid">
            <?php foreach( $lightbox_gallery as $image ): ?>
                <div class="uk-width-1-1 uk-width-1-2@m uk-width-1-4@l uk-margin-medium-bottom">
                    <a href="<?php echo wp_get_attachment_image_src( $image['image'], 'full' )[0]; ?>" data-lightbox="gallery" data-caption="<?php echo esc_attr($image['caption']); ?>" class="lightbox-anchor">
