...
?>
    ...
    <?php elseif($display == "product"): ?>
        <div id="<?php echo $rand_id;?>" class="fc-section-cards fc-section-cards-simple fc-section-cards-products grid-container uk-grid uk-grid-match">
    <?php else: ?>
